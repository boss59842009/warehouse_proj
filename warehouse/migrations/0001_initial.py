# Generated by Django 4.2 on 2025-04-12 06:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auto_backup",
                    models.BooleanField(
                        default=True, verbose_name="Автоматичне резервне копіювання"
                    ),
                ),
                (
                    "backup_frequency",
                    models.PositiveIntegerField(
                        default=1, verbose_name="Частота резервного копіювання (днів)"
                    ),
                ),
                (
                    "last_backup",
                    models.DateTimeField(
                        blank=True,
                        null=True,
                        verbose_name="Останнє резервне копіювання",
                    ),
                ),
                (
                    "backup_location",
                    models.CharField(
                        default="backups/",
                        max_length=255,
                        verbose_name="Місце зберігання резервних копій",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=100, verbose_name="Назва культури"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=50, verbose_name="Одиниця виміру"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=200, verbose_name="Назва продукту"),
                ),
                (
                    "real_name",
                    models.CharField(max_length=200, verbose_name="Назва справжня"),
                ),
                (
                    "lot_number",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="Номер лоту"
                    ),
                ),
                (
                    "import_name",
                ...
                (
                    "packages_count",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Кількість упаковок"
                    ),
                ),
                (
                    "image",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity_expected",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Очікувана кількість"
                    ),
                ),
                (
                    "quantity_actual",
                    models.PositiveIntegerField(
                        default=0, verbose_name="Фактична кількість"
                    ),
                ),
                (
                    "difference",
                    models.IntegerField(default=0, verbose_name="Відхилення"),
                ),
                (
                    "comment",
                    models.TextField(blank=True, null=True, verbose_name="Коментар"),
